        ...
        <div style={{position:"fixed",inset:0,zIndex:155,display:"flex",alignItems:"flex-end"}} onClick={()=>setShowPrivacy(false)}>
          ...
          <div onClick={e=>e.stopPropagation()} style={{position:"relative",background:"#111827",border:"1px solid #374151",borderRadius:"24px 24px 0 0",width:"100%",maxWidth:520,margin:"0 auto",paddingBottom:"calc(28px + env(safe-area-inset-bottom))",boxShadow:"0 -8px 48px rgba(0,0,0,0.7)",maxHeight:"85vh",overflowY:"auto"}}>
            ...
            <div style={{padding:"8px 20px 16px"}}>
              ...
              {lang==="de"?(
                <p style={{fontSize:12,color:"#9ca3af",lineHeight:1.8,margin:0,whiteSpace:"pre-line"}}>{`1. Verantwortlicher\nLars Frädrich, Veit-Stoß-Straße 64, 80687 München\nE-Mail: hello@nubetracker.com\nFür Datenschutzanfragen wenden Sie sich bitte direkt an die oben genannte E-Mail-Adresse.\n\n2. Grundsätze der Datenverarbeitung\nWir verarbeiten personenbezogene Daten im Einklang mit der DSGVO und dem BDSG.\n\n3. Hosting und Server-Logs\nDiese Website wird gehostet von:\nVercel Inc., 340 Pine Street, Suite 701, San Francisco, CA 94104, USA\n\nBei jedem Seitenaufruf verarbeitet Vercel automatisch:\nIP-Adresse (anonymisiert), Browsertyp, Betriebssystem, Uhrzeit und Datum des Zugriffs, aufgerufene URL.\n\nRechtsgrundlage: Art. 6 Abs. 1 lit. f DSGVO (berechtigtes Interesse an der technischen Bereitstellung und Verbesserung des Dienstes).\nSpeicherdauer: 30 Tage, danach automatische Löschung.\n\nDatentransfer in die USA: Vercel Inc. ist zertifiziert unter dem EU-US Data Privacy Framework (Beschluss der EU-Kommission vom 10. Juli 2023). Zusätzlich bestehen EU-Standardvertragsklauseln gemäß Art. 46 Abs. 2 lit. c DSGVO.\nAuftragsverarbeitung: Mit Vercel Inc. besteht ein Auftragsverarbeitungsvertrag gemäß Art. 28 DSGVO.\nWeitere Infos: https://vercel.com/legal/privacy-policy\n\n4. Lokale Datenspeicherung (localStorage)\nAlle eingegebenen Lebensmitteldaten werden ausschließlich lokal auf deinem Gerät gespeichert. Diese Daten verlassen dein Gerät nicht und werden nicht an uns oder Dritte übermittelt.\nRechtsgrundlage: Art. 6 Abs. 1 lit. b DSGVO\n\n5. Analyse (Vercel Analytics)\nWir nutzen Vercel Analytics zur anonymisierten Analyse der Nutzung unseres Dienstes zum Zweck der Verbesserung des Angebots. Vercel Analytics setzt keine Cookies, erfasst keine personenbezogenen Daten und speichert keine IP-Adressen.\nRechtsgrundlage: Art. 6 Abs. 1 lit. f DSGVO (berechtigtes Interesse an der Verbesserung des Dienstangebots).\nWiderspruchsrecht: Du kannst der Verarbeitung im Rahmen von Vercel Analytics jederzeit widersprechen, indem du einen gängigen Werbeblocker oder einen Browser mit entsprechenden Datenschutzeinstellungen verwendest.\n\n6. Cookies\nDiese Website verwendet keine Cookies.\n\n7. Deine Rechte\nAuskunft (Art. 15 DSGVO), Berichtigung (Art. 16 DSGVO), Löschung (Art. 17 DSGVO), Einschränkung (Art. 18 DSGVO), Widerspruch (Art. 21 DSGVO), Datenübertragbarkeit (Art. 20 DSGVO)\n\nZur Ausübung deiner Rechte wende dich an: hello@nubetracker.com\n\n8. Beschwerderecht\nBayerisches Landesamt für Datenschutzaufsicht (BayLDA)\nPromenade 18, 91522 Ansbach\nwww.lda.bayern.de\n\n9. Stand: April 2026`}</p>
              ):(
                <p style={{fontSize:12,color:"#9ca3af",lineHeight:1.8,margin:0,whiteSpace:"pre-line"}}>{`1. Controller\nLars Frädrich, Veit-Stoß-Straße 64, 80687 München, Germany\nEmail: hello@nubetracker.com\nFor data protection enquiries please contact the email address above.\n\n2. Hosting and Server Logs\nHosted by: Vercel Inc., 340 Pine Street, Suite 701, San Francisco, CA 94104, USA\n\nOn each page visit Vercel automatically processes:\nIP address (anonymized), browser type, operating system, time and date of access, accessed URL.\n\nLegal basis: Art. 6 (1) lit. f GDPR (legitimate interest in the technical provision and improvement of the service).\nRetention: 30 days, then automatic deletion.\n\nData transfer to the USA: Vercel Inc. is certified under the EU-US Data Privacy Framework (European Commission adequacy decision of 10 July 2023). EU Standard Contractual Clauses pursuant to Art. 46 (2) lit. c GDPR are additionally in place.\nData processing agreement: A data processing agreement pursuant to Art. 28 GDPR has been concluded with Vercel Inc.\nMore info: https://vercel.com/legal/privacy-policy\n\n3. Local Data Storage (localStorage)\nAll food data you enter is stored exclusively on your device. This data does not leave your device and is not transmitted to us or third parties.\nLegal basis: Art. 6 (1) lit. b GDPR\n\n4. Analytics (Vercel Analytics)\nWe use Vercel Analytics for anonymized analysis of service usage in order to improve our offering. Vercel Analytics does not set cookies, does not collect personal data and does not store IP addresses.\nLegal basis: Art. 6 (1) lit. f GDPR (legitimate interest in improving the service).\nRight to object: You may object to processing by Vercel Analytics at any time by using a common ad blocker or a browser with appropriate privacy settings.\n\n5. Cookies\nThis website does not use cookies.\n\n6. Your Rights\nAccess (Art. 15 GDPR), Rectification (Art. 16 GDPR), Erasure (Art. 17 GDPR), Restriction (Art. 18 GDPR), Object (Art. 21 GDPR), Portability (Art. 20 GDPR)\n\nTo exercise your rights please contact: hello@nubetracker.com\n\n7. Supervisory Authority\nBayerisches Landesamt für Datenschutzaufsicht (BayLDA)\nPromenade 18, 91522 Ansbach, Germany\nwww.lda.bayern.de\n\n8. Last updated: April 2026`}</p>
              )}
            </div>
          </div>
        </div>
