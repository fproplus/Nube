...
const SYNERGY_DETAILS = {
  en: [
    ...
    {id:"vitc_iron",title:"Vitamin C + Iron",emoji:"🍊+🥩",short:"Iron absorption supercharged",explanation:"Non-haem iron is absorbed as Fe³⁺ but must be reduced to Fe²⁺ for intestinal uptake. Vitamin C acts as a reducing agent, forming a soluble complex that resists inhibitory effects of phytates and polyphenols. Adding a vitamin-C-rich food to an iron-rich meal can increase absorption 2–6 fold.",needs:["Bell Pepper","Orange","Lemon","Kiwi","Broccoli","Strawberries"]},
    ...
    {id:"vitd_calcium",title:"Vitamin D + Calcium",emoji:"☀️+🦴",short:"Bone absorption maximised",explanation:"Vitamin D3 (calcitriol) is essential for calcium absorption in the gut. Without adequate Vitamin D, only 10–15% of dietary calcium is absorbed; with sufficient Vitamin D this rises to 30–40%. Vitamin D upregulates the calcium transport protein calbindin in intestinal cells, making the combination far more effective than either alone.",needs:["Salmon","Sardines","Mackerel","Eggs","Mushrooms","Kefir"]},
...
const NUTRIENT_INFO = {
  vitamins:{
    ...
    B12:{en:{role:"Nerve function. Only in animal foods.",tops:["Liver (Beef)","Oysters","Salmon","Tuna","Mackerel","Beef","Eggs"]},de:{role:"Nervenfunktion. Nur in tierischen Lebensmitteln.",tops:["Rinderleber","Austern","Lachs","Thunfisch","Makrele","Rindfleisch","Eier"]}},
    C:{en:{role:"Immune powerhouse and collagen synthesis.",tops:["Bell Pepper","Kiwi","Orange","Strawberries","Broccoli","Kale","Mango"]},de:{role:"Immunbooster und Kollagensynthese.",tops:["Paprika","Kiwi","Orange","Erdbeeren","Brokkoli","Grünkohl","Mango"]}},
    D:{en:{role:"Bone strength and immune modulation.",tops:["Salmon","Sardines","Mackerel","Eggs","Tuna","Mushrooms","Kefir"]},de:{role:"Knochenstärke und Immunmodulation.",tops:["Lachs","Sardinen","Makrele","Eier","Thunfisch","Pilze","Kefir"]}},
  ...
  minerals:{
    Calcium:{en:{role:"Bone strength, muscle contraction and nerve signalling.",tops:["Parmesan","Emmental","Skyr","Cheddar","Gouda","Greek Yogurt","Sardines","Kefir"]},de:{role:"Knochen- und Zahnstärke.",tops:["Parmesan","Emmentaler","Skyr","Cheddar","Gouda","Griechischer Joghurt","Sardinen","Kefir"]}},
    ...
    Iron:{en:{role:"Oxygen transport. Pair with Vitamin C for best absorption.",tops:["Liver (Beef)","Oysters","Beef","Lentils","Spinach","Pumpkin Seeds"]},de:{role:"Sauerstofftransport.",tops:["Rinderleber","Austern","Rindfleisch","Linsen","Spinat","Kürbiskerne"]}},
    ...
    Zinc:{en:{role:"Immune function and wound healing.",tops:["Oysters","Pumpkin Seeds","Beef","Liver (Beef)","Lentils","Quinoa"]},de:{role:"Immunfunktion und Wundheilung.",tops:["Austern","Kürbiskerne","Rindfleisch","Rinderleber","Linsen","Quinoa"]}},
  }
};
